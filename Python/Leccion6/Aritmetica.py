class Aritmetica:
    ...
    esto es documento de la clase en python
...
aritmetica1 = Aritmetica(6, 7) # Le pasamos los argumentos para los operandos
...
print(f'La division de lo numeros es: {aritmetica1.dividir():.2f}')